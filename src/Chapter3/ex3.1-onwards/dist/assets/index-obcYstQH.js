    ...
    children: (0, m.jsx)(() => {
      ...
      (0, d.useEffect)(() => {
        ...
        In()
          ...
          .catch((e) => {
            h('failed to fetch data from server')
          }))
      }, [])
      let y = async (r) => {
          ...
          if (
            ...
            Rn(o.id, a)
              ...
              .catch((e) => {
                ...
                h(`failed to update ${n} in server`)
              })
            return
          } else if (o) {
          ...
          Ln(a)
            .then((r) => {
              (t(e.concat(r)), p(`added ${n} to server`))
            })
            .catch((e) => {
              h('failed to add person to server')
            }))
        },
        b = (e) => {
          r(e.target.value)
