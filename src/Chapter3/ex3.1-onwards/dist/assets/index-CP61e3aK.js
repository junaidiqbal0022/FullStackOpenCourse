...
var Fn = '/api/persons',
  ...
  Ln = async (e) => (await P.post(Fn, e)).data,
  Rn = (e, t) => P.put(`${Fn}/${e}`, t).then((e) => e.data),
  zn = (e) => P.delete(`${Fn}/${e}`).then((e) => e.data),
  Bn = ({ errorMessage: e }) =>
    e
    ...
    children: (0, m.jsx)(() => {
      ...
      (0, d.useEffect)(() => {
        ...
        In()
          ...
          .catch((e) => {
            b('failed to fetch data from server ', e)
          }))
      }, [])
      let x = async (r) => {
          ...
          let a = { name: n, number: i, id: e.length + 1 }
          var o = e.find((e) => e.name === a.name)
          if (
            o &&
            window.confirm(
            ...
            Rn(o.id, a)
              .then((r) => {
                (t(e.map((e) => (e.id === o.id ? r : e))),
                y(`updated ${n} in server`))
              })
              .catch((e) => {
                if (e.response?.status === 404) {
                  b(`Person ${n} was not found on server side.`)
                  return
                }
                b(`failed to update ${n} in server`)
              })
            return
          } else if (o) {
          ...
          (console.log('personObject is', a),
          Ln(a)
            .then((i) => {
              (t(e.concat(i))
                .then(() => {
                  console.log('persons after adding new person', e)
                })
                .catch((e) => {
                  if (
                    (console.error(
                    ...
                    e.name == Hn.DuplicateEntry)
                  ) {
                    if (
                      (b(`Person with name ${n} already exists on server.`),
                      !p)
                    )
                      (h(!0),
                      setTimeout(() => {
                      ...
                      (b('failed to update local data ', e),
                      console.log(
                        'already looping, not calling getAllPersons again',
                      ))
                      return
                    }
                    return (
              ...
              console.log('person added successfully', i),
              y(`added ${n} to server`))
            })
            .catch((e) => {
              b('failed to add person to server ', e)
            }))
        },
        ee = (e) => {
          r(e.target.value)
        ...
        C = (r, i) => {
          ...
          zn(r)
            ...
            .catch((e) => {
              ...
              b(`failed to delete ${i} from server`)
            }))
        }
      return (0, m.jsxs)('div', {
        children: [
          ...
          (0, m.jsx)(Bn, { errorMessage: c }),
          (0, m.jsx)(Vn, { successMessage: u }),
          (0, m.jsx)(_, {
            onSubmit: x,
            onChangeName: ee,
            onPhoneChange: S,
